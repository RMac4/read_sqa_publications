...
-   Collect data
    ...
    -   **Output**: Outputs sheet names, data tables, and notes into the R global environment.
...
-   `extract_publication_data.R`
    -   contains a function `extract_publication_data()` that creates a file path to the location of an SQA statistical excel publication either from the web or on the local device and then extracts the sheet names, data tables, and notes of an SQA statistical excel publication into the global environment.

...
-   Collect data
    -   **Description**: Creates the file patch for the data tables and extracts sheet names, data tables, and notes. Can be set to a web link or local file path.
    -   **Scripts**: Runs the R script `extract_publication_data.R`.
    -   **Output**: Outputs sheet names, data tables, and notes either directly into the R global environment or as a nested list.
